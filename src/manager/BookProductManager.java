...
public class BookProductManager {
    ...
    public void ProductChange(Product[] products) {
        ...
        for (int i = 0; i < products.length; i++) {
            System.out.printf("%d. Название продукта: %s Количество: %s Цена: %s%n"
                    , i + 1
                    , products[i].getTitle()
        ...
        System.out.print("Изменить цену продукта? (y/n)");
        ...
        System.out.print("Изменить количество данного товара на складе? (y/n)");
        edit = scanner.nextLine();
        if (edit.equals("y")) {
            System.out.print("Введите другое количество товара: ");
